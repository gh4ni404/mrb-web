        ...
        ['img' => 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?q=80&w=150', 'name' => 'Tgk. Syarifuddin M. Yusuf', 'role' => 'Muadzin Jumat Utama', 'badge' => 'Muadzin'],
                                ...
                                <section id="news" class="py-24 bg-soft-gray border-b border-soft-gray-2">
                                    <div class="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
                                        ...
                                        {{-- Tab Buttons --}}
                                        <div class="flex justify-center mb-12 reveal-on-scroll">
                                            <div class="flex flex-wrap gap-2.5">
                                                <button
                                                    class="news-tab font-sans font-bold text-xs px-5 py-2.5 rounded-full border border-soft-gray-2 hover:border-gold/30 hover:text-gold cursor-pointer hover:scale-105 transition-all duration-300 active"
                                                    data-tab="berita">Berita Terkini</button>
                                                <button
                                                    class="news-tab bg-white text-charcoal-light/70 font-sans font-bold text-xs px-5 py-2.5 rounded-full border border-soft-gray-2 hover:border-gold/30 hover:text-gold cursor-pointer hover:scale-105 transition-all duration-300"
                                                    data-tab="khutbah">Arsip Khutbah</button>
                                                <button
                                                    class="news-tab bg-white text-charcoal-light/70 font-sans font-bold text-xs px-5 py-2.5 rounded-full border border-soft-gray-2 hover:border-gold/30 hover:text-gold cursor-pointer hover:scale-105 transition-all duration-300"
                                                    data-tab="artikel">Artikel Keislaman</button>
                                            </div>
                                        </div>

                                        {{-- Tab Content: Berita --}}
                                        <div class="tab-panel" id="tab-berita">
                                            @if($latestNews->count())
                                                <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-16">
                                                    @php $featured = $latestNews->first(); @endphp
                                                    <div class="lg:col-span-7 reveal-on-scroll">
                                                        <div
                                                            class="bg-white rounded-xl overflow-hidden border border-soft-gray-2 flex flex-col shadow-md card-hover-lift group">
                                                            <div class="h-64 md:h-80 overflow-hidden relative img-zoom-hover">
                                                                @if($featured->getFirstMediaUrl('thumbnail'))
                                                                    <img src="{{ $featured->getFirstMediaUrl('thumbnail') }}" alt="{{ $featured->title }}"
                                                                        class="w-full h-full object-cover" />
                                                                @endif
                                                                <span
                                                                    class="absolute top-4 left-4 bg-emerald text-white text-[10px] tracking-wider uppercase font-bold px-3.5 py-1 rounded-full">UTAMA</span>
                                                            </div>
                                                            <div class="p-3 md:p-4">
                                                                <div
                                                                    class="flex flex-wrap items-center gap-3 text-[11px] text-charcoal-light/60 font-sans mb-3">
                                                                    ...
                                                                    <span class="flex items-center gap-1.5">
                                                                        ...
                                                                        {{ $featured->published_at?->format('d M Y H:m') }}
                                                                    </span>
                                                                </div>
                                                                <h3
                                                                    class="font-sans font-bold text-xl md:text-2xl text-charcoal mt-2 mb-3 leading-tight group-hover:text-emerald transition-colors">
                                                                    {{ $featured->title }}
                                                                    <span class="font-sans font-extrabold text-[10px] text-gold uppercase tracking-wider">{{ $featured?->categories?->pluck('name')->join(', ') }}</span>
                                                                </h3>

                                                                <p class="font-sans text-sm text-charcoal-light/75 leading-relaxed mb-5">
                                                                    {{ str($featured->excerpt)->limit(150) }}
                                                                </p>
                                                                <a href="#"
                                                                    class="inline-flex items-center gap-2 bg-emerald hover:bg-emerald-light text-white font-sans font-bold text-xs px-5 py-2.5 rounded-md transition-all duration-300">
                                                                    Baca Selengkapnya <iconify-icon icon="ph:arrow-right" width="14"></iconify-icon>
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>

                                                    <div class="lg:col-span-5 flex flex-col gap-5 reveal-on-scroll delay-200">
                                                        @foreach($latestNews->skip(1) as $news)
                                                            <div
                                                                class="bg-white rounded-xl overflow-hidden border border-soft-gray-2 shadow-sm card-hover-lift group cursor-pointer flex gap-4 p-4">
                                                                <div class="w-20 h-20 md:w-24 md:h-24 rounded-lg overflow-hidden flex-shrink-0 img-zoom-hover">
                                                                ...
                                                                <div class="flex-1 min-w-0">
                                                                    <span
                                                                        class="font-sans font-extrabold text-[9px] text-gold uppercase tracking-wider">{{ $news->categories?->first()?->name ?? 'Berita' }}</span>
                                                                    <h4
                                                                        class="font-sans font-bold text-sm text-charcoal mt-1 line-clamp-2 leading-snug group-hover:text-emerald transition-colors">
                                                                        {{ $news->title }}
                                                                    </h4>
                                                                    <p class="font-sans text-[11px] text-charcoal-light/50 mt-2">
                                                                        {{ $news->published_at?->format('j M Y') ?? '' }} •
                                                                        {{ $news->author?->name ?? 'Humas' }}</p>
                                                                </div>
                                                            </div>
                                                        @endforeach
                                                    </div>
                                            ...
                                            @else
                                                <div class="text-center py-16 text-charcoal-light/60">
                                        ...
                                        {{-- Tab Content: Khutbah --}}
                                        <div class="tab-panel hidden" id="tab-khutbah">
                                            @if($latestKhutbah->count())
                                                <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                                                    @php $featuredKhutbah = $latestKhutbah->first(); @endphp
                                                    <div class="lg:col-span-7 reveal-on-scroll">
                                                        <div
                                                            class="bg-white rounded-xl overflow-hidden border border-soft-gray-2 shadow-md card-hover-lift group">
                                                            <div class="h-72 md:h-80 overflow-hidden img-zoom-hover">
                                                                @if($featuredKhutbah->getFirstMediaUrl('thumbnail'))
                                                                    <img src="{{ $featuredKhutbah->getFirstMediaUrl('thumbnail') }}"
                                                                        alt="{{ $featuredKhutbah->title }}" class="w-full h-full object-cover" />
                                                                @endif
                                                            </div>
                                                            <div class="p-6 md:p-8">
                                                                <div
                                                                    class="flex flex-wrap items-center gap-3 text-[11px] text-charcoal-light/60 font-sans mb-3">
                                                                    <span class="flex items-center gap-1.5"><iconify-icon icon="ph:user"></iconify-icon>
                                                                        {{ $featuredKhutbah->author?->name ?? 'Khatib' }}</span>
                                                                    <span class="flex items-center gap-1.5"><iconify-icon
                                                                            icon="ph:calendar-blank"></iconify-icon>
                                                                        {{ $featuredKhutbah->published_at?->format('j M Y') ?? '' }}</span>
                                                                </div>
                                                                <h3
                                                                    class="font-sans font-bold text-xl md:text-2xl text-charcoal leading-tight mb-3 group-hover:text-emerald transition-colors">
                                                                    {{ $featuredKhutbah->title }}
                                                                </h3>
                                                                <p class="font-sans text-sm text-charcoal-light/75 leading-relaxed mb-5">
                                                                    {{ str($featuredKhutbah->excerpt)->limit(150) }}
                                                                </p>
                                                                <a href="#"
                                                                    class="inline-flex items-center gap-2 bg-gold hover:bg-gold-light text-emerald-dark font-sans font-bold text-xs px-5 py-2.5 rounded-md transition-all duration-300">
                                                                    <iconify-icon icon="ph:download-simple" width="14"></iconify-icon> Unduh Khutbah (PDF)
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>

                                                    <div class="lg:col-span-5 flex flex-col gap-3 reveal-on-scroll delay-200">
                                                        @foreach($latestKhutbah->skip(1) as $khutbah)
                                                            <div
                                                                class="bg-white rounded-xl border border-soft-gray-2 shadow-sm p-4 card-hover-lift group cursor-pointer">
                                                                <span
                                                                    class="font-sans font-semibold text-[11px] text-gold tracking-wide">{{ $khutbah->author?->name ?? 'Khatib' }}</span>
                                                                <h4
                                                                    class="font-sans font-bold text-sm text-charcoal mt-0.5 line-clamp-2 leading-snug group-hover:text-emerald transition-colors">
                                                                    {{ $khutbah->title }}
                                                                </h4>
                                                                <p class="font-sans text-[11px] text-charcoal-light/50 mt-1.5">
                                                                    {{ $khutbah->published_at?->format('j M Y') ?? '' }}</p>
                                                            </div>
                                                        @endforeach
                                                    </div>
                                                </div>
                                            @else
                                                <div class="text-center py-16 text-charcoal-light/60">
                                                    <iconify-icon icon="ph:scroll" class="text-5xl mb-4"></iconify-icon>
                                                    <p class="font-sans text-lg">Belum ada arsip khutbah.</p>
                                                </div>
                                            @endif
                                        </div>

                                        {{-- Tab Content: Artikel --}}
                                        <div class="tab-panel hidden" id="tab-artikel">
                                            @if($latestArticle->count())
                                                <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                                                    @php $featuredArticle = $latestArticle->first(); @endphp
                                                    <div class="lg:col-span-7 reveal-on-scroll">
                                                        <div
                                                            class="bg-white rounded-xl overflow-hidden border border-soft-gray-2 shadow-md card-hover-lift group">
                                                            <div class="h-72 md:h-80 overflow-hidden img-zoom-hover">
                                                                @if($featuredArticle->getFirstMediaUrl('thumbnail'))
                                                                    <img src="{{ $featuredArticle->getFirstMediaUrl('thumbnail') }}"
                                                            ...
                                                            <div class="p-6 md:p-8">
                                                                <div
                                                                    class="flex flex-wrap items-center gap-3 text-[11px] text-charcoal-light/60 font-sans mb-3">
                                                                    <span class="flex items-center gap-1.5"><iconify-icon icon="ph:user"></iconify-icon>
                                                                        {{ $featuredArticle->author?->name ?? 'Kontributor' }}</span>
                                                                    <span class="flex items-center gap-1.5"><iconify-icon
                                                                            icon="ph:calendar-blank"></iconify-icon>
                                                                        {{ $featuredArticle->published_at?->format('j M Y') ?? '' }}</span>
                                                                </div>
                                                                <h3
                                                                    class="font-sans font-bold text-xl md:text-2xl text-charcoal leading-tight mb-3 group-hover:text-emerald transition-colors">
                                                                ...
                                                                <p class="font-sans text-sm text-charcoal-light/75 leading-relaxed mb-5">
                                                                    {{ str($featuredArticle->excerpt)->limit(150) }}
                                                                </p>
                                                                <a href="#"
                                                                    class="inline-flex items-center gap-2 bg-emerald hover:bg-emerald-light text-white font-sans font-bold text-xs px-5 py-2.5 rounded-md transition-all duration-300">
                                                                    Baca Artikel <iconify-icon icon="ph:arrow-right" width="14"></iconify-icon>
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="lg:col-span-5 flex flex-col gap-5 reveal-on-scroll delay-200">
                                                        @foreach($latestArticle->skip(1) as $article)
                                                            <div
                                                                class="bg-white rounded-xl overflow-hidden border border-soft-gray-2 shadow-sm card-hover-lift group cursor-pointer flex gap-4 p-4">
                                                                <div class="w-20 h-20 md:w-24 md:h-24 rounded-lg overflow-hidden flex-shrink-0 img-zoom-hover">
                                                                    @if($article->getFirstMediaUrl('thumbnail'))
                                                                        <img src="{{ $article->getFirstMediaUrl('thumbnail', 'thumb') }}"
                                                                            alt="{{ $article->title }}" class="w-full h-full object-cover" />
                                                                    @endif
                                                                </div>
                                                                <div class="flex-1 min-w-0">
                                                                    <span
                                                                        class="font-sans font-extrabold text-[9px] text-gold uppercase tracking-wider">{{ $article->categories?->first()?->name ?? 'Artikel' }}</span>
                                                                    <h4
                                                                        class="font-sans font-bold text-sm text-charcoal mt-1 line-clamp-2 leading-snug group-hover:text-emerald transition-colors">
                                                                        {{ $article->title }}
                                                                    </h4>
                                                                    <p class="font-sans text-[11px] text-charcoal-light/50 mt-2">
                                                                        ...
                                                                        {{ $article->author?->name ?? 'Kontributor' }}</p>
                                                                </div>
                                                            </div>
                                                        @endforeach
                                                    </div>
                                            ...
                                            @else
                                                <div class="text-center py-16 text-charcoal-light/60">
                                                    <iconify-icon icon="ph:note-pencil" class="text-5xl mb-4"></iconify-icon>
                                                    <p class="font-sans text-lg">Belum ada artikel.</p>
                                                </div>
                                            @endif
                                        </div>
                                ...
                                <script>
                                    (function initNewsTabs() {
                                        ...
                                        const panels = {
                                            ...
                                            khutbah: document.getElementById('tab-khutbah'),
                                            artikel: document.getElementById('tab-artikel'),
                                        };
                                        ...
                                        tabs.forEach(function (tab) {
                                            tab.addEventListener('click', function () {
                                                tabs.forEach(function (t) {
                                                    ...
                                                    t.classList.add('bg-white', 'text-charcoal-light/70', 'border', 'border-soft-gray-2', 'hover:text-gold');
                                                });
                                                this.classList.add('active', 'bg-gold', 'text-charcoal');
                                                this.classList.remove('bg-white', 'text-charcoal-light/70', 'border', 'border-soft-gray-2', 'hover:text-gold');
