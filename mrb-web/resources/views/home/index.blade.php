                        ...
                        <div class="lg:col-span-7 reveal-on-scroll">
                            <div
                                ...
                                <div class="p-3 md:p-4">
                                    ...
                                    <span
                                        class="font-sans font-extrabold text-[10px] text-gold uppercase tracking-wider">{{ $featured?->categories?->pluck('name')->join(', ') }}</span>
                                ...
                                <div class="p-6 md:p-8">
                                    <div
                                        ...
                                        <span class="flex items-center gap-1.5"><iconify-icon icon="ph:user"></iconify-icon>
                                            {{ $featuredKhutbah->khatib_name ?? $featuredKhutbah->author?->name ?? 'Khatib' }}</span>
                        ...
                        <div class="lg:col-span-5 flex flex-col gap-3 reveal-on-scroll delay-200">
                            @foreach($latestKhutbah->skip(1) as $khutbah)
                                <div
                                    class="bg-white rounded-xl overflow-hidden border border-soft-gray-2 shadow-sm card-hover-lift group cursor-pointer flex gap-4 p-4">
                                    <div class="w-20 h-20 md:w-24 md:h-24 rounded-lg overflow-hidden flex-shrink-0 img-zoom-hover">
                                        @if($khutbah->getFirstMediaUrl('thumbnail'))
                                            <img src="{{ $khutbah->getFirstMediaUrl('thumbnail', 'thumb') }}" alt="{{ $news->title }}"
                                                class="w-full h-full object-cover" />
                                        @endif
                                    </div>
                                    <div class="flex-1 min-w-0">
                                        <span
                                            class="font-sans font-semibold text-[11px] text-gold tracking-wide">{{ $khutbah->khatib_name ?? $khutbah->author?->name ?? 'Khatib' }}</span>
                                        <h4
                                        ...
                                        <p class="font-sans text-[11px] text-charcoal-light/50 mt-1.5">
                                            {{ $khutbah->published_at?->format('j M Y') ?? '' }}
                                        </p>
                                    </div>
                                </div>
                            @endforeach
                                ...
                                <div
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <p class="font-sans text-[11px] text-charcoal-light/50 mt-2">
                                            ...
                                            {{ $article->author?->name ?? 'Kontributor' }}
                                        </p>
                                    </div>
                                </div>
                            @endforeach
